...
****Funnel Chart is prepared which depicts ratings by rating status.Ratings are further categorized into using DAX switch true function as mentioned below:
							 *Good 
							 * Poor  
							 *Average 
